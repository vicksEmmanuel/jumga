        ...
        queryData === null || queryData === void 0 ? void 0 : queryData.forEach(doc => {
            ...
            if (searchProps.filter) {
                if ((data.starRating <= searchProps.filterCustomerRating) && //Chec customer ratings
                    ...
                    (categories.includes(searchProps.searchId) || productName.includes(searchProps.searchId))) {
                    result.push(data);
                }
            }
            else {
                if (categories.includes(searchProps.searchId) || productName.includes(searchProps.searchId)) {
                    result.push(data);
                }
            }
        });
