...
const getOrders = functions.https.onCall(async (datax, context) => {
    ...
    const orderProps = {
        email: orderDetails === null || orderDetails === void 0 ? void 0 : orderDetails.email,
    ...
    try {
        ...
        const query = orderDB.where('isSentToDeliveryTeam', '==', false).where('email', '==', orderProps.email);
...
//# sourceMappingURL=getOrder.f.js.map